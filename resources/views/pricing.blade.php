...
<!-- Mirrored from theme.codeastrology.com/listghor/pricing.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Mar 2021 10:00:25 GMT -->
<head>
		<!-- all meta -->
		<meta charset="UTF-8">
	...
	<body>
		...
		<!-- Start listghor_pricing section -->
		<section class="listghor_pricing_v1 section_padding wow fadeInUp">
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-4 col-md-6 col-sm-12">
						<div class="pricing_box wow fadeInUp">
							...
							<div class="pricing_botton">
								<a href="#" class="pricing_btn listghor_btn">purchase now</a>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 col-sm-12">
						<div class="pricing_box wow fadeInUp">
							<div class="pricing_title bg_active">
								<span>Standard</span>
								<h2>$49.90</h2>
								<p>BILLING PER MONTH</p>
							</div>
		...
		</section><!-- End listghor_pricing section -->
		<!-- Start listghor_faq section -->
		<section class="listghor_faq listghor_faq_1 gray_bg section_padding">
			<div class="container">
				<div class="row justify-content-center">
					<div class="col-lg-7">
						<div class="listghor_title text-center">
						...
						<div class="search_form">
							<form>
								<div class="form_group">
									<input type="text" class="form_control" placeholder="Search asked question" name="search" required>
									<button class="class listghor_btn search_btn"><i class="fas fa-search"></i></button>
								</div>
							</form>
						</div>
					</div>
				...
				<div class="row justify-content-center">
					<div class="col-lg-10">
						<div class="listghor_faq_acoridian faq_acoridian_1">
                            <div id="accordion">
                                <div class="card">
                                    <div class="card-header" id="headingOne">
                                        <a href="#" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true">How does Lorem Ipsum work?
                                ...
                                <div class="card">
                                    <div class="card-header" id="headingTwo">
                                        <a href="#" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false">Where does it come from?
                                           	<i class="fas fa-minus"></i>
                                            <i class="fas fa-plus"></i>
                                        </a>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header" id="headingThree">
                                        <a href="#" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">Where can I get some?
                                            <i class="fas fa-minus"></i>
                                            <i class="fas fa-plus"></i>
                                        </a>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header" id="heading4">
                                        <a href="#" data-toggle="collapse" data-target="#collapse4" aria-expanded="false" aria-controls="collapse4">Why do we use it?
                                            <i class="fas fa-minus"></i>
                                            <i class="fas fa-plus"></i>
                                        </a>
                                    </div>
