...
<!-- Mirrored from theme.codeastrology.com/listghor/registration.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Mar 2021 10:01:07 GMT -->
<head>
		<!-- all meta -->
		<meta charset="UTF-8">
	...
	<body>
		...
		<!-- Start listghor_registration section -->
				...
				<div class="listghor_wrapper_form">
					...
					<div class="wrapper_form_right">
						...
						<div class="listghor_form">
							<form action="https://theme.codeastrology.com/listghor/registration.html" method="post" class="registration_from">
								<div class="form_group">
									<input type="text" class="form_control" placeholder="Full Name"  name="name" required>
									<i class="fas fa-user"></i>
								</div>
								<div class="form_group">
									<input type="text" class="form_control" placeholder="User Name"  name="name" required>
									<i class="fas fa-user"></i>
								</div>
								<div class="form_group">
									<input type="email" class="form_control" placeholder="E-mail address" name="email" required>
								...
								<div class="form_button">
									<button class="listghor_btn form_btn">sign up</button>
									<span>or</span>
									<a href="#">log in</a>
								</div>
								<div class="form_text">
		...
		<!-- End listghor_registration section -->
