...
<head>
	...
	<body>
		...
		<section class="hero_bg hero_v2 light_bg">
			<svg id="head_shape" width="1013px" height="1013px"><path fill-rule="evenodd"  fill="rgb(67, 188, 64    )" d="M1.000,-0.000 C1.000,-0.000 -18.082,170.553 187.000,205.999 C561.196,270.675 193.939,1012.999 1013.000,1012.999 C1013.000,170.999 1013.000,-0.000 1013.000,-0.000 L1.000,-0.000 Z"/></svg>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-6 col-sm-12">
						<div class="work_box iconshape_5">
							<div class="listghor_icon">
								<svg id="icon_shape_3" width="190px" height="155px"> <path fill-rule="evenodd"  fill="rgb(67, 188, 64   )" d="M1.408,30.506 C2.937,19.614 14.059,-2.593 38.972,0.312 C63.886,3.217 81.159,26.025 117.240,22.345 C153.322,18.666 174.283,29.027 184.698,49.575 C195.113,70.122 187.182,93.311 173.757,106.790 C160.332,120.270 140.621,119.716 125.667,121.237 C110.712,122.756 101.703,129.768 87.347,142.693 C72.990,155.617 57.211,158.484 45.141,148.670 C33.071,138.856 36.060,105.062 33.155,95.346 C30.250,85.630 15.400,75.334 9.290,64.627 C3.180,53.919 -0.712,45.614 1.408,30.506 Z"/></svg>
								<svg id="icon_shape_4" width="181px" height="178px"><path fill-rule="evenodd"  opacity="0.102" fill="rgb(67, 188, 64    )" d="M40.000,130.999 C70.202,126.504 77.354,139.303 106.000,161.000 C134.645,182.696 166.883,182.421 179.000,160.000 C184.397,150.012 174.531,136.702 168.000,108.999 C161.469,81.297 177.483,52.529 169.000,26.999 C163.521,10.511 125.435,-10.014 94.000,5.999 C52.582,27.098 75.895,41.827 19.000,77.999 C-16.971,100.869 5.305,136.163 40.000,130.999 Z"/></svg>
					...
					<div class="col-lg-4 col-md-6 col-sm-12">
						<div class="work_box">
							<div class="listghor_icon">
								<svg id="icon_shape_5" width="190px" height="155px"> <path fill-rule="evenodd"  fill="rgb(67, 188, 64   )" d="M1.408,30.506 C2.937,19.614 14.059,-2.593 38.972,0.312 C63.886,3.217 81.159,26.025 117.240,22.345 C153.322,18.666 174.283,29.027 184.698,49.575 C195.113,70.122 187.182,93.311 173.757,106.790 C160.332,120.270 140.621,119.716 125.667,121.237 C110.712,122.756 101.703,129.768 87.347,142.693 C72.990,155.617 57.211,158.484 45.141,148.670 C33.071,138.856 36.060,105.062 33.155,95.346 C30.250,85.630 15.400,75.334 9.290,64.627 C3.180,53.919 -0.712,45.614 1.408,30.506 Z"/></svg>
								<svg id="icon_shape_6" width="181px" height="178px"><path fill-rule="evenodd"  opacity="0.102" fill="rgb(67, 188, 64    )" d="M40.000,130.999 C70.202,126.504 77.354,139.303 106.000,161.000 C134.645,182.696 166.883,182.421 179.000,160.000 C184.397,150.012 174.531,136.702 168.000,108.999 C161.469,81.297 177.483,52.529 169.000,26.999 C163.521,10.511 125.435,-10.014 94.000,5.999 C52.582,27.098 75.895,41.827 19.000,77.999 C-16.971,100.869 5.305,136.163 40.000,130.999 Z"/></svg>
