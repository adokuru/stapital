...
<!-- Mirrored from theme.codeastrology.com/listghor/listing_grid_sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Mar 2021 09:59:48 GMT -->
<head>
		<!-- all meta -->
		<meta charset="UTF-8">
	...
	<body>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="breadcrumb_content text-center">
							<h2>listing grid with sidebar</h2>
		...
		<!-- Start listghor_listing_grid section -->
		<section class="listing_style_v1 listing_grid_sidebar section_padding wow fadeInUp">
			<div class="container">
				<div class="row">
					<div class="col-lg-8">
						<div class="listing_grid_wrapper row">
							<div class="col-lg-6 col-md-6 col-sm-12">
								<div class="listing_item_box wow fadeInUp">
									<div class="listghor_img">
										<img src="assets/images/list_1.jpg" alt="">
							...
							<div class="col-lg-6 col-md-6 col-sm-12">
								<div class="listing_item_box wow fadeInUp">
									<div class="listghor_img">
										<img src="assets/images/list_2.jpg" alt="">
										<a href="listing_details.html"><div class="overlay_img"></div></a>
										<div class="overlay_content">
											<ul>
												<li class="icon"><a href="#"><i class="fas fa-cocktail"></i></a></li>
							...
							<div class="col-lg-6 col-md-6 col-sm-12">
								<div class="listing_item_box wow fadeInUp">
									<div class="listghor_img">
										<img src="assets/images/list_3.jpg" alt="">
										<a href="listing_details.html"><div class="overlay_img"></div></a>
										<div class="overlay_content">
											<ul>
												<li class="icon"><a href="#"><i class="fas fa-cocktail"></i></a></li>
							...
							<div class="col-lg-6 col-md-6 col-sm-12">
								<div class="listing_item_box wow fadeInUp">
									<div class="listghor_img">
										<img src="assets/images/list_4.jpg" alt="">
										<a href="listing_details.html"><div class="overlay_img"></div></a>
										<div class="overlay_content">
											<ul>
												<li class="icon"><a href="#"><i class="fas fa-cocktail"></i></a></li>
							...
							<div class="col-lg-6 col-md-6 col-sm-12">
								<div class="listing_item_box wow fadeInUp">
									<div class="listghor_img">
										<img src="assets/images/list_5.jpg" alt="">
										<a href="listing_details.html"><div class="overlay_img"></div></a>
										<div class="overlay_content">
											<ul>
												<li class="icon"><a href="#"><i class="fas fa-cocktail"></i></a></li>
									...
									<div class="listing_info">
										<div class="post_info">
											<h3><a href="listing_details.html">Park Regis Kris Kin Hotel</a></h3>
											<h4 class="price">30.00</h4>
											<p class="location">Al Mankhool Road, Dubai</p>
										</div>
										<div class="post_meta">
							...
							<div class="col-lg-6 col-md-6 col-sm-12">
								<div class="listing_item_box wow fadeInUp">
									<div class="listghor_img">
										<img src="assets/images/list_6.jpg" alt="">
										<a href="listing_details.html"><div class="overlay_img"></div></a>
										<div class="overlay_content">
											<ul>
												<li class="icon"><a href="#"><i class="fas fa-cocktail"></i></a></li>
									...
									<div class="listing_info">
										<div class="post_info">
											<h3><a href="listing_details.html">Golden Sands Hotel Apartments</a></h3>
											<h4 class="price">30.00</h4>
											<p class="location">Al Mankhool Road, Dubai</p>
										</div>
										<div class="post_meta">
							...
							<div class="col-lg-6 col-md-6 col-sm-12">
								<div class="listing_item_box wow fadeInUp">
									<div class="listghor_img">
										<img src="assets/images/list_8.jpg" alt="">
										<a href="listing_details.html"><div class="overlay_img"></div></a>
										<div class="overlay_content">
											<ul>
												<li class="icon"><a href="#"><i class="fas fa-cocktail"></i></a></li>
		...
		<!-- End listghor_listing_grid section -->
...
<!-- Mirrored from theme.codeastrology.com/listghor/listing_grid_sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Mar 2021 09:59:53 GMT -->
</html>