...
<head>
	...
	<body>
		...
		<!-- Start header_area -->
		<header class="header_area header_v4">
			<div class="container">
				<!-- site_menu -->
				<div class="site_menu">
					<div class="row align-items-center">
						<div class="col-lg-3">
							<div class="listghor_logo">
								<a href="index-2.html"><img src="assets/images/logo.png" class="img-fluid" alt=""></a>
							</div>
						</div>
						<div class="col-lg-7">
		...
		<!-- Start listghor_error_404 section -->
		<section class="listghor_error_404 wow fadeInUp">
			<img src="assets/images/cloud_1.png" alt="" class="cloud cloud_1">
			<img src="assets/images/cloud_2.png" alt="" class="cloud cloud_2">
			<img src="assets/images/cloud_3.png" alt="" class="cloud cloud_3">
			<div class="container">
				<div class="row justify-content-center">
					<div class="col-lg-8">
						<div class="content_404 text-center">
							<img src="assets/images/404.png" alt="">
							<h2>OOPS! WE CAN’T FIND THE PAGE</h2>
							<a href="#" class="listghor_btn">go to home</a>
						</div>
					</div>
				</div>
			</div>
		</section><!-- End listghor_error_404 section -->
...
<!-- Mirrored from theme.codeastrology.com/listghor/404.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Mar 2021 10:00:44 GMT -->
</html>