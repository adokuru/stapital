...
<!-- Mirrored from theme.codeastrology.com/listghor/listing_list.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Mar 2021 09:59:37 GMT -->
<head>
		<!-- all meta -->
		<meta charset="UTF-8">
	...
	<body>
		...
		<section class="listing_style_v4 listing_list_left_sidebar section_padding wow fadeInUp">
			<div class="container">
				<div class="row">
					<div class="col-lg-8">
						<div class="listghor_listing_wrapper">
							<div class="listing_item_box">
								<div class="listghor_img">
									<img src="assets/images/list_9.jpg" alt="">
									<a href="listing_details.html" class="overlay_img"></a>
									<div class="overlay_content">
										<ul>
											<li><a href="#" class="overlay_btn">205 listing</a></li>
											<li></li>
										</ul>
									</div>
								</div>
								<div class="listing_info">
									<div class="post_info">
										<h3><a href="listing_details.html">Metropol Apartment near Elagin</a></h3>
										<h4 class="price">10.00</h4>
										<p class="location">Momofuku Las Vegas, Las Vegas, United States</p>
										<ul class="st_rateing">
											<li><i class="fas fa-star"></i><span>4.5</span></li>
											<li><a href="#">178</a><span> Reviews</span></li>
										</ul>
										<p class="st_content">Lorem Ipsum is simply dummy text of the printing and settingtyp industry. Standard dummy text ever since the 1500</p>
									</div>
									<div class="post_meta">
										<ul>
							...
							<div class="listing_item_box">
								<div class="listghor_img">
									<img src="assets/images/list_10.jpg" alt="">
									<a href="listing_details.html" class="overlay_img"></a>
									<div class="overlay_content">
										<ul>
											<li><a href="#" class="overlay_btn">205 listing</a></li>
							...
							<div class="listing_item_box">
								<div class="listghor_img">
									<img src="assets/images/list_11.jpg" alt="">
									<a href="listing_details.html" class="overlay_img"></a>
									<div class="overlay_content">
										<ul>
											<li><a href="#" class="overlay_btn">205 listing</a></li>
								...
								<div class="listing_info">
									<div class="post_info">
										<h3><a href="listing_details.html">Hotel Skt Petri</a></h3>
										<h4 class="price">10.00</h4>
										<p class="location">Momofuku Las Vegas, Las Vegas, United States</p>
										<ul class="st_rateing">
											<li><i class="fas fa-star"></i><span>4.5</span></li>
							...
							<div class="listing_item_box">
								<div class="listghor_img">
									<img src="assets/images/list_12.jpg" alt="">
									<a href="listing_details.html" class="overlay_img"></a>
									<div class="overlay_content">
										<ul>
											<li><a href="#" class="overlay_btn">205 listing</a></li>
								...
								<div class="listing_info">
									<div class="post_info">
										<h3><a href="listing_details.html">Park Hotel Farrer Park</a></h3>
										<h4 class="price">10.00</h4>
										<p class="location">Momofuku Las Vegas, Las Vegas, United States</p>
										<ul class="st_rateing">
											<li><i class="fas fa-star"></i><span>4.5</span></li>
							...
							<div class="listing_item_box">
								<div class="listghor_img">
									<img src="assets/images/list_13.jpg" alt="">
									<a href="listing_details.html" class="overlay_img"></a>
									<div class="overlay_content">
										<ul>
											<li><a href="#" class="overlay_btn">205 listing</a></li>
								...
								<div class="listing_info">
									<div class="post_info">
										<h3><a href="listing_details.html">Copenhagen Admiral Hotel</a></h3>
										<h4 class="price">10.00</h4>
										<p class="location">Momofuku Las Vegas, Las Vegas, United States</p>
										<ul class="st_rateing">
											<li><i class="fas fa-star"></i><span>4.5</span></li>
							...
							<div class="listing_item_box">
								<div class="listghor_img">
									<img src="assets/images/list_14.jpg" alt="">
									<a href="listing_details.html" class="overlay_img"></a>
									<div class="overlay_content">
										<ul>
											<li><a href="#" class="overlay_btn">205 listing</a></li>
								...
								<div class="wb_check_list">
									<div class="single_checkbox">
										<input type="radio" class="single_input" id="check6" name="radio1">
									  	<label class="single_input_label sigle_input_check" for="check6"><img src="assets/images/rateing_1.png" alt=""></label>
									</div>
									<div class="single_checkbox">
										<input type="radio" class="single_input" id="check7" name="radio1">
									  	<label class="single_input_label sigle_input_check" for="check7"><img src="assets/images/rateing_2.png" alt=""></label>
									</div>
									<div class="single_checkbox">
										<input type="radio" class="single_input" id="check8" name="radio1">
									  	<label class="single_input_label sigle_input_check" for="check8"><img src="assets/images/rateing_3.png" alt=""></label>
									</div>
									<div class="single_checkbox">
										<input type="radio" class="single_input" id="check9" name="radio1">
									  	<label class="single_input_label sigle_input_check" for="check9"><img src="assets/images/rateing_4.png" alt=""></label>
									</div>
									<div class="single_checkbox">
										<input type="radio" class="single_input" id="check10" name="radio1">
									  	<label class="single_input_label sigle_input_check" for="check10"><img src="assets/images/rateing_5.png" alt=""></label>
									</div>
								</div>
							</div>
...
<!-- Mirrored from theme.codeastrology.com/listghor/listing_list.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Mar 2021 09:59:44 GMT -->
</html>