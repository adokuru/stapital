...
<!-- Mirrored from theme.codeastrology.com/listghor/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Mar 2021 10:00:39 GMT -->
<head>
		<!-- all meta -->
		<meta charset="UTF-8">
	...
	<body>
		...
		<section class="listing_contact_v2 section_padding">
			<div class="container">
				<div class="row align-items-center">
					<div class="col-lg-6">
						<div class="listghor_img_box contact_img_box wow fadeInLeft">
							<div class="listghor_img">
								<img src="assets/images/contact_2.png" class="img-fluid" alt="">
							</div>
						</div>
					</div>
					<div class="col-lg-6">
						<div class="listghor_content_box">
							...
							<div class="contact_form">
								<form>
									...
									<div class="form_group">
										<input type="text" class="form_control" placeholder="Your Subject" required>
									</div>
									<div class="form_group">
										<textarea class="form_control" placeholder="Your Message" required></textarea>
									</div>
									<div class="form_button">
										<button class="listghor_btn form_btn">submit</button>
									</div>
								</form>
							</div>
						</div>
		...
		</section><!-- End listghor_contact section -->
		<!-- Start listghor_contact_info section -->
		<section class="contact_info_v1 section_padding">
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-4 col-md-6 col-sm-12">
						<div class="listghor_box wow fadeInUp">
							<div class="listghor_icon">
								<i class="fas fa-envelope"></i>
							</div>
							<div class="listghor_info">
								<h5>Our Mail address</h5>
					...
					<div class="col-lg-4 col-md-6 col-sm-12">
						<div class="listghor_box wow fadeInUp">
							...
							<div class="listghor_info">
								<h5>Our Phone No</h5>
								<p><a href="tel:+1234567890">+123 456 7890m</a></p>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 col-sm-12">
		...
		<!-- Start listghor_contact_info section -->
		<!-- Start listghor_map section -->
		<section class="listghor_map_v1 section_padding">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<div class="map_area">
